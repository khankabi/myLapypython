...
for further knowledge follow this link : https://requests.readthedocs.io/en/latest/user/quickstart/#make-a-request
"""



# this code will find all h2 tags in cwh's website
# import requests
