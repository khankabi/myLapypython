...
Name mangling in Python is a technique used to protect class-private and superclass-private attributes from being accidentally overwritten by subclasses. Names of class-private and superclass-private attributes are transformed by the addition of a single leading underscore and a double leading underscore respectively.
 ...
 - name ko aesa bana do k koi accidently overwrite na kar de proper way k through hi use overwrite kar saktey ho
class MyClass:
    def __init__(self):
...
obj2=dept()
try:
    print(obj.__name) #will throuw error
except:
    print("error because of mangling concept ")
print(obj2._emp__name) #name mangling


"""
double underscore : private and mangling
single underscore : private,protected and non mangling"""